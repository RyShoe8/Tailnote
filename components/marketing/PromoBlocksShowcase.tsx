...
function BookACallDemo() {
  return (
    <div className="space-y-2">
      <p className="text-xs font-semibold uppercase tracking-wide text-slate-500">Free consult</p>
...
function ListDemo() {
  return (
    <div className="space-y-2">
      <p className="text-xs font-semibold uppercase tracking-wide text-slate-500">Featured offers</p>
      <ul className="space-y-1 text-sm">
        <li className="flex items-start gap-2">
          <span className="mt-[0.5em] h-1.5 w-1.5 shrink-0 rounded-full bg-primary" aria-hidden />
...
function ImageDemo() {
  return (
    <div className="space-y-2">
      <p className="text-xs font-semibold uppercase tracking-wide text-slate-500">Featured promo</p>
...
export function PromoBlocksShowcase({ showHeader = true, className = '' }: Props) {
  return (
