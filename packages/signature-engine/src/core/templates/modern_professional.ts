            ...
            <table cellpadding="0" cellspacing="0" border="0" style="border-collapse:separate;border:1px solid #e5e7eb;border-radius:24px;width:40px;text-align:center;">
              <tr><td style="padding-top:12px;">
                <table cellpadding="0" cellspacing="0" border="0" align="center" style="margin:0 auto;">
                  {{#if linkedin}}<tr><td style="padding-bottom:12px;"><a href="{{linkedin}}"><img src="{{iconLinkedin}}" width="18" height="18" style="display:block;width:18px;height:18px;" /></a></td></tr>{{/if}}
                  {{#if instagram}}<tr><td style="padding-bottom:12px;"><a href="{{instagram}}"><img src="{{iconInstagram}}" width="18" height="18" style="display:block;width:18px;height:18px;" /></a></td></tr>{{/if}}
                  {{#if facebook}}<tr><td style="padding-bottom:12px;"><a href="{{facebook}}"><img src="{{iconFacebook}}" width="18" height="18" style="display:block;width:18px;height:18px;" /></a></td></tr>{{/if}}
                  {{#if youtube}}<tr><td style="padding-bottom:12px;"><a href="{{youtube}}"><img src="{{iconYoutube}}" width="18" height="18" style="display:block;width:18px;height:18px;" /></a></td></tr>{{/if}}
                  {{#if reddit}}<tr><td style="padding-bottom:12px;"><a href="{{reddit}}"><img src="{{iconReddit}}" width="18" height="18" style="display:block;width:18px;height:18px;" /></a></td></tr>{{/if}}
                  {{#if discord}}<tr><td style="padding-bottom:12px;"><a href="{{discord}}"><img src="{{iconDiscord}}" width="18" height="18" style="display:block;width:18px;height:18px;" /></a></td></tr>{{/if}}
                  {{#if bluesky}}<tr><td style="padding-bottom:12px;"><a href="{{bluesky}}"><img src="{{iconBluesky}}" width="18" height="18" style="display:block;width:18px;height:18px;" /></a></td></tr>{{/if}}
                </table>
              </td></tr>
            </table>
          </td>
