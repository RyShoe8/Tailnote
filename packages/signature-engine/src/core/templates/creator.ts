 ...
 */
export const CREATOR_SIGNATURE_TEMPLATE = `<table class="sig-creator-root" cellpadding="0" cellspacing="0" border="0" width="100%" style="max-width: 550px; font-family: {{fontFamily}}, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; background-color: {{primaryColor}}; border-radius: 8px; border-left: 4px solid {{creatorAccentColor}};">
  <tr>
